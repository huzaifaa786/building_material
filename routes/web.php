...
Route::post('admin/login', [AdminController::class, 'login'])->name('admin.auth.loginn');
...
Route::post('admin/create', [VendorController::class, 'store'])->name('admin.vendor.createe');
Route::view('admin/allvendor', 'admin.vendor.allvendor')->name('admin.vendor.allvendor');
Route::get('admin/vendor/allvendors', [VendorController::class, 'show'])->name('admin.vendor.allvendorr');
...
Route::post('vendor/login', [VendorController::class, 'login'])->name('vendor.auth.loginn');
