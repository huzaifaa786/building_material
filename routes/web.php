...
Route::view('vendor/product/create', 'vendor.product.create');
...
Route::post('vendor/product/create', [ProductController::class, 'store'])->name('vendor.productcreate');
...
Route::get('vendor/product/allproducts', [ProductController::class, 'index'])->name('vendor.product.allproducts');
...
Route::view('admin/create', 'admin.vendor.create');
Route::post('admin/create', [VendorController::class, 'store'])->name('admin.vendor.create');
Route::view('admin/allvendor', 'admin.vendor.allvendor');
Route::get('admin/vendor/allvendors', [VendorController::class, 'show'])->name('admin.vendor.allvendor');
...
Route::view('vendor/login', 'vendor.auth.login');
Route::post('vendor/login', [VendorController::class, 'vendorLogin'])->name('vendor.auth.login');
