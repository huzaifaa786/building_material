    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Material Services</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('vendor.dashboard.dashboard') }}">
            ...
            {{-- <li class="nav-item">
                ...
                <div id="collapseUnits" class="collapse" aria-labelledby="headingUnits" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                ...
                <div id="collapseProduct" class="collapse" aria-labelledby="headingProduct"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <h6 class="collapse-header">Custom Utilities:</h6> --}}
                        <a class="collapse-item" href="{{ route('vendor.product.create') }}">Create Product</a>
                        <a class="collapse-item" href="{{ route('vendor.product.allproducts') }}">All product</a>
            ...
            {{-- <a class="collapse-item" href=""> Create Vendor</a> --}}
            {{-- <a class="collapse-item" href="">All Vendor</a> --}}
            ...
            {{-- <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Material Services</strong> is packed with premium features, components,
                    and more!</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary btn-user rounded-pill"
                        href="{{ route('vendor.auth.login') }}">Logout</a>
                    @csrf
                </div>
            </div>
        </div>
